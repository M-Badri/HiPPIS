...
echo '"HiPPIS/Fortran/Drivers/Mapping/Makefile" and "HiPPIS/Fortran/Drivers/BOMEX/Makefile" for the'
...
cd ../../Extras
echo ''
echo 'The vectorization results are in "Drivers/Mapping/vectorization_results"'
echo ''
