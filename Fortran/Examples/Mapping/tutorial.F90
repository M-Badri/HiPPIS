...
!---------------------------------------------------------------------------------------------!
  ...
  real(kind=8)				:: vout_apprx(m), v2Dout_apprx(m,m) v3Dout(m,m,m)
  ...
  call adaptiveInterpolation2D(x, y, n, n, v2D, xout, yout, m, m, vout_appx2D, d, interpolation_type, sten, eps0, eps1 ) 
